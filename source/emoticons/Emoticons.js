var SpazEmoticons; if (!SpazEmoticons) SpazEmoticons = {};
...
// CHARS_TO_ESCAPE.
SpazEmoticons.buildRegexp = function(mappings) {
    var result = "";
...
SpazEmoticons.convertEmoticons = function(msg, regexp, mappings, className) {
    return msg.replace(
        regexp,
